...
public class EmailClient {
    ...
    public void sendEmail(String receiver, String content) throws UnsupportedEncodingException, MessagingException {
        ...
        try (InputStream in = Files.newInputStream(Paths.get("D:\\Code\\OOAD_Project-main\\v1\\src\\main\\resources\\mail.properties")))
        {
            properties.load(in);
        } catch (IOException e) {
        ...
        try (InputStream in = Files.newInputStream(Paths.get("D:\\Code\\OOAD_Project-main\\v1\\src\\main\\resources\\passwd.properties")))
        {
            host.load(in);
        } catch (IOException e) {
            throw new RuntimeException(e);
